...
var _vueSlickCarousel = _interopRequireDefault(require("vue-slick-carousel"));
...
_vue["default"].use(_bootstrapVue.IconsPlugin); //carousel 
...
_vue["default"].use(_vueSlickCarousel["default"]);
